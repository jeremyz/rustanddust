...
import ch.asynk.creepingarmor.engine.Move;
import ch.asynk.creepingarmor.engine.SelectedTile;
import ch.asynk.creepingarmor.engine.ObjectiveSet;
import ch.asynk.creepingarmor.engine.OrderList;
...
import ch.asynk.creepingarmor.engine.gfx.animations.AnimationSequence;
import ch.asynk.creepingarmor.engine.gfx.animations.DiceAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.FireAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.TankFireAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.InfantryFireAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.PromoteAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.DestroyAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.SoundAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.RunnableAnimation;
import ch.asynk.creepingarmor.engine.gfx.animations.MoveToAnimation.MoveToAnimationCb;
...
public abstract class Map extends Board implements MoveToAnimationCb, ObjectiveSet.ObjectiveCb
{
    ...
    public Map(final CreepingArmor game, Board.Config cfg, String textureName)
    {
    ...
    {
        CreepingArmor.debug("  Move", String.format("%s %s", move.type, move.toString()));
    ...
    {
        CreepingArmor.debug("Command", cmd.toString());
    ...
    {
        CreepingArmor.debug("TurnDone", String.format(" Processed Commands : %d", commands.size()));
    ...
    public void revertMoves()
    {
        for (Unit unit: activatedUnits) {
            CreepingArmor.debug("    revertMove() " + unit);
    ...
    {
        CreepingArmor.debug("    revertEnter() "+ unit);
        removePawn(unit);
        objectives.revert(this);
