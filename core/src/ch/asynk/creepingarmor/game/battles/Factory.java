...
import ch.asynk.creepingarmor.game.Unit.UnitType;
import ch.asynk.creepingarmor.game.Battle;
import ch.asynk.creepingarmor.game.battles.BattleHeadToHead;
import ch.asynk.creepingarmor.game.battles.BattleFrontalAssault;
import ch.asynk.creepingarmor.game.battles.BattleLastStand;
import ch.asynk.creepingarmor.game.battles.BattleCounterAttack;
import ch.asynk.creepingarmor.game.battles.BattleStabToTheFlank;
import ch.asynk.creepingarmor.game.battles.BattleNightAction;
import ch.asynk.creepingarmor.game.battles.BattleTest;
...
public class Factory implements Board.TileBuilder, Disposable
{
    ...
    public Factory(final CreepingArmor game)
    {
        this.game = game;
