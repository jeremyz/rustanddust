...
import ch.asynk.creepingarmor.ui.Msg;
import ch.asynk.creepingarmor.ui.OkCancel;
import ch.asynk.creepingarmor.ui.Widget;
import ch.asynk.creepingarmor.game.hud.PlayerInfo;
import ch.asynk.creepingarmor.game.hud.ActionButtons;
import ch.asynk.creepingarmor.game.hud.StatisticsPanel;
import ch.asynk.creepingarmor.game.hud.EngagementPanel;
...
public class Hud implements Disposable, Animation
{
    ...
    public Hud(final Ctrl ctrl, final CreepingArmor game)
    {
        this.game = game;
        this.ctrl = ctrl;
