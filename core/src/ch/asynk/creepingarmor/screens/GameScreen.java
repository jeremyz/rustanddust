...
public class GameScreen implements Screen
{
    ...
    public GameScreen(final CreepingArmor game)
    {
    ...
    {
        // CreepingArmor.debug("GameScreen", "resize (" + width + "," + height + ")");
    ...
    public void dispose()
    {
        // CreepingArmor.debug("GameScreen", "dispose()");
        batch.dispose();
        ctrl.dispose();
    ...
    public void show()
    {
        // CreepingArmor.debug("GameScreen", "show()");
    }

    @Override
    public void hide()
    {
        // CreepingArmor.debug("GameScreen", "hide()");
    }
    ...
    public void resume()
    {
        // CreepingArmor.debug("GameScreen", "resume()");
    }
}
